...
\begin{frame}
  ...
  \begin{minipage}{0.24\linewidth}
    ...
    \includegraphics[width=\linewidth]{objects-blob.pdf}
  \end{minipage}  
  \pause
  \begin{minipage}{0.24\linewidth}
    \centering\small Trees\\
    \includegraphics[width=\linewidth]{objects-tree.pdf}
  \end{minipage}  
  \pause
  \begin{minipage}{0.24\linewidth}
    \centering\small Commits\\
    \includegraphics[width=\linewidth]{objects-commit.pdf}
  \end{minipage}  
  \pause
  \begin{minipage}{0.24\linewidth}
    \centering\small Tags\\
    \includegraphics[width=\linewidth]{objects-tag.pdf}
  \end{minipage}  
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
    \frame{\includegraphics[scale=0.3]{git-cheat-sheet.pdf}}
  \end{center}
\end{frame}
